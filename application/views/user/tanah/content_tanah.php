<div class="container">
  ...
  <ul class="slides">
    <li data-thumb="<?= base_url($res); ?>images/ss.jpg">
      <img src="<?= base_url($res); ?>images/ss.jpg" />
    </li>
    <li data-thumb="<?= base_url($res); ?>images/ss1.jpg">
      <img src="<?= base_url($res); ?>images/ss1.jpg" />
    </li>
    <li data-thumb="<?= base_url($res); ?>images/ss2.jpg">
      <img src="<?= base_url($res); ?>images/ss2.jpg" />
    </li>
    <li data-thumb="<?= base_url($res); ?>images/ss3.jpg">
      <img src="<?= base_url($res); ?>images/ss3.jpg" />
    </li>
  </ul>
</div>
<!-- FlexSlider -->
  <script defer src="<?= base_url($res); ?>js/jquery.flexslider.js"></script>
<link rel="stylesheet" href="<?= base_url($res); ?>css/flexslider.css" type="text/css" media="screen" />
